...
snakemake -s "${SCRIPTPATH}/../../ncov_minipipe.snake" --configfile test.config \
   --use-singularity --cores 1 --forcerun -p --notemp \
   --singularity-args "--bind ${TMPDIR} --bind ${SCRIPTPATH}/../../"
